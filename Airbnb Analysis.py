...
# page configuration
page_icon_url = '/Users/vpro/Downloads/airbnb logo png - Google Search_files/images(10)'
...
with st.sidebar:
    image_url = '/Users/vpro/Downloads/airbnb_banner.jpg'
...
df = pd.read_csv('/Users/vpro/Downloads/airbnb.csv')
...
if option=="Features Analysis":
    dinesh  = pymongo.MongoClient("mongodb+srv://r_dineshkumar:rdineshkumar@cluster0.e1g0htd.mongodb.net/?retryWrites=true&w=majority")
    ...
    st.write("https://public.tableau.com/app/profile/dineshkumar.r8704/viz/Book1_16978644811640/Dashboard1?publish=yes")
